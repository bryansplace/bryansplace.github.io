### Introduction
Immich is a popular selfhosted replacement for Google photos. Casting to Google chromcast devices is a hassle as the required HTTPS connection requires setting up certificates.
